                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdown07">
                            <li><a class="dropdown-item" href="{{ route('dep.show', ['id' =>1]) }}">Dep N1</a></li>
                            <li><a class="dropdown-item" href="{{ route('dep.show', ['id' =>'2']) }}">Dep N1</a></li>
                            <li><a class="dropdown-item" href="{{ route('dep.show', ['id' =>'3']) }}">Dep N1</a></li>
                            <li>
